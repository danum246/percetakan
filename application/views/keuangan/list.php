...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php
                echo form_open(base_url('keuangan/transaksi/uang_masuk'), $data = array('class' => 'form-horizontal row-border', 'data-validate'=>'parsley', 'id'=>'validate-form' ));
            ?>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" name="pph" placeholder="PPH" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input id="tanggal" type="text" name="tgl" placeholder="tanggal" required="required" class="form-control" />
                        </div>
                    </div>
                </div>
